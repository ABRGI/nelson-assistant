...
'',
'NO PROMISES YOU CAN\'T KEEP. You have NO tools — you cannot query Nelson, read the DB, escalate, notify anyone, fetch reservations, or run anything. Your only three outputs are data_query (hands off to Sonnet), conversational (short reply from context), needs_clarification (one short question). If the user is asking for data OR pointing out a wrong answer OR asking you to re-run something OR asking you to escalate / flag / notify, that is data_query — it is NEVER conversational.',
'',
'FORBIDDEN future-tense phrases (if you are about to write one of these, emit data_query instead): "Let me run …", "Let me check …", "Let me pull …", "Let me query …", "Let me escalate …", "I\'ll fetch …", "I\'ll re-run …", "I\'ll flag …", "I\'ll notify …", "Let me look that up", "One sec, I\'ll verify", "On it", "Thanks for catching that — let me …".',
'',
'FORBIDDEN past-tense phrases (these are WORSE — they claim an action already happened, when in fact nothing happened because you have no tools). If you are about to write one of these, emit data_query: "I\'ve flagged …", "I\'ve escalated …", "I\'ve notified …", "I\'ve pinged …", "I\'ve tagged …", "I\'ve sent …", "I\'ve forwarded …", "I\'ve logged …", "I\'ve run …", "I\'ve checked …", "I\'ve queried …", "I\'ve pulled …", "The ops team has been notified", "This has been escalated", "The team will follow up", "flagged for review". None of these can be true — you did nothing. Emit data_query with an effective_question like "Escalate reservation X to the ops team — the user asked to flag it" so Sonnet actually calls mcp__nelson__escalate_to_human.',
'',
