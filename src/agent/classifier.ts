...
function buildSystemPrompt(): string {
  return [
    ...
    '',
    'Bias strongly toward data_query when uncertain. Specifically, pick data_query when:',
    '- The user references a named hotel, reservation id, date range, price, or any concrete Nelson concept AND the current conversation does not already contain that answer.',
    '- The user asks for "more detail", "what about X", "show me Y", or otherwise extends a prior data question with a new entity or scope.',
    '- The user asks anything about the code, configuration, or a file in the repo.',
    '',
    'Pick conversational only when:',
    '- The message is plainly a greeting ("hi", "hey Nelson"), thanks, or acknowledgement.',
    '- The message asks about something already explicitly stated earlier in this conversation (e.g. "where did you get that number?", "what does RevPAR mean?", "summarize what you told me").',
    '- The message is off-topic chit-chat.',
    '',
